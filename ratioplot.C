...
void ratioplot(int trackqual = 1, string tag = "", string subleading = "", int nmin = 130, int nmax = 160, int centmin = 0, int centmax = 4, float ajmin = 0.0 , float ajmax = 1.0, float tptmin = 14, float tptmax = 16, float aptmin = 1, float aptmax = 2,int leadingjetptlow = 100 , int leadingjetpthigh = 300,  string draw = "corr", float zmax = -1000 , float zmin = -1000)
{
  int jetnum = 0;
  ...
  cout<<Form("signal_%sleadingjet%d_%d_ass%d_%d_cmin%d_cmax%d_ajmin%d_ajmax%d",subleading.data(),(int)leadingjetptlow,(int)leadingjetpthigh,(int)aptmin,(int)aptmax,centmin,centmax,(int)(ajmin*100),(int)(ajmax*100))<<endl;
	...
	TH2D * SigLead = (TH2D*)file->Get(Form("signal_%sleadingjet%d_%d_ass%d_%d_cmin%d_cmax%d_ajmin%d_ajmax%d","",(int)leadingjetptlow,(int)leadingjetpthigh,(int)aptmin,(int)aptmax,centmin,centmax,(int)(ajmin*100),(int)(ajmax*100)));
	TH2D * BackLead = (TH2D*)file->Get(Form("background_%sleadingjet%d_%d_ass%d_%d_cmin%d_cmax%d_ajmin%d_ajmax%d","",(int)leadingjetptlow,(int)leadingjetpthigh,(int)aptmin,(int)aptmax,centmin,centmax,(int)(ajmin*100),(int)(ajmax*100)));
	TH2D * SigSublead = (TH2D*)file->Get(Form("signal_%sleadingjet%d_%d_ass%d_%d_cmin%d_cmax%d_ajmin%d_ajmax%d","sub",(int)leadingjetptlow,(int)leadingjetpthigh,(int)aptmin,(int)aptmax,centmin,centmax,(int)(ajmin*100),(int)(ajmax*100)));
	TH2D * BackSublead = (TH2D*)file->Get(Form("background_%sleadingjet%d_%d_ass%d_%d_cmin%d_cmax%d_ajmin%d_ajmax%d","sub",(int)leadingjetptlow,(int)leadingjetpthigh,(int)aptmin,(int)aptmax,centmin,centmax,(int)(ajmin*100),(int)(ajmax*100)));
  ...
  CorrSublead->Divide(BackSublead);
	CorrSublead->Scale(B0Sublead/(bwx*bwy*Ntrig->Integral(2,300)));
  ...
  if(draw.compare("corr")==0)
	...
	{
    c1->SaveAs(Form("diff_%sleadingjet%d_%d_ass%d_%d_cmin%d_cmax%d_ajmin%d_ajmax%d.png",subleading.data(),(int)leadingjetptlow,(int)leadingjetpthigh,(int)aptmin,(int)aptmax,centmin,centmax,(int)(ajmin*100),(int)(ajmax*100)));
	}
  else if(draw.compare("ratio")==0)
	{
    c1->SaveAs(Form("ratio_%sleadingjet%d_%d_ass%d_%d_cmin%d_cmax%d_ajmin%d_ajmax%d.png",subleading.data(),(int)leadingjetptlow,(int)leadingjetpthigh,(int)aptmin,(int)aptmax,centmin,centmax,(int)(ajmin*100),(int)(ajmax*100)));
	}
