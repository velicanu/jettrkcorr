...
void eplot(int trkqual = 1, string filename = "", int nmin = 130, int nmax = 160, float tptmin = 14, float tptmax = 16, float aptmin = 1, float aptmax = 2, string draw = "corr", float zmax = -1 , float zmin = -1)
{
  ...
  if(filename.compare("HIRun2013-PromptReco-v1-HLT_PAPixelTrackMultiplicity130_FullTrack12-sort")==0)
	...
	if(filename.compare("HIRun2013-PromptReco-v1-HLT_PAPixelTracks_Multiplicity190_v1")==0)
    lmult = new TLatex(0.01, 0.95, Form("CMS pPb' %d #leq N < %d", nmin, nmax));
