...
// Fri Mar 21 16:49:27 2014 by ROOT version 5.32/00
...
public :
   ...
   Float_t         b;
   Int_t           nref;
   Float_t         rawpt[400];   //[nref]
   Float_t         jtpt[400];   //[nref]
   Float_t         jteta[400];   //[nref]
   Float_t         jty[400];   //[nref]
   Float_t         jtphi[400];   //[nref]
   Float_t         jtpu[400];   //[nref]
   Float_t         jtm[400];   //[nref]
   Float_t         discr_fr01[400];   //[nref]
   Float_t         trackMax[400];   //[nref]
   Float_t         trackSum[400];   //[nref]
   Int_t           trackN[400];   //[nref]
   Float_t         trackHardSum[400];   //[nref]
   Int_t           trackHardN[400];   //[nref]
   Float_t         chargedMax[400];   //[nref]
   Float_t         chargedSum[400];   //[nref]
   Int_t           chargedN[400];   //[nref]
   Float_t         chargedHardSum[400];   //[nref]
   Int_t           chargedHardN[400];   //[nref]
   Float_t         photonMax[400];   //[nref]
   Float_t         photonSum[400];   //[nref]
   Int_t           photonN[400];   //[nref]
   Float_t         photonHardSum[400];   //[nref]
   Int_t           photonHardN[400];   //[nref]
   Float_t         neutralMax[400];   //[nref]
   Float_t         neutralSum[400];   //[nref]
   Int_t           neutralN[400];   //[nref]
   Float_t         hcalSum[400];   //[nref]
   Float_t         ecalSum[400];   //[nref]
   Float_t         eMax[400];   //[nref]
   Float_t         eSum[400];   //[nref]
   Int_t           eN[400];   //[nref]
   Float_t         muMax[400];   //[nref]
   Float_t         muSum[400];   //[nref]
   Int_t           muN[400];   //[nref]
   Float_t         matchedPt[400];   //[nref]
   Float_t         matchedRawPt[400];   //[nref]
   Float_t         matchedPu[400];   //[nref]
   Float_t         matchedR[400];   //[nref]
   Int_t           beamId1;
   Int_t           beamId2;
   Float_t         pthat;
   Float_t         refpt[400];   //[nref]
   Float_t         refeta[400];   //[nref]
   Float_t         refy[400];   //[nref]
   Float_t         refphi[400];   //[nref]
   Float_t         refdphijt[400];   //[nref]
   Float_t         refdrjt[400];   //[nref]
   Float_t         refparton_pt[400];   //[nref]
   Int_t           refparton_flavor[400];   //[nref]
   Int_t           refparton_flavorForB[400];   //[nref]
   Float_t         genChargedSum[400];   //[nref]
   Float_t         genHardSum[400];   //[nref]
   Float_t         signalChargedSum[400];   //[nref]
   Float_t         signalHardSum[400];   //[nref]
   Int_t           subid[400];   //[nref]
   Int_t           ngen;
   Int_t           genmatchindex[20];   //[ngen]
   Float_t         genpt[20];   //[ngen]
   Float_t         geneta[20];   //[ngen]
   Float_t         geny[20];   //[ngen]
   Float_t         genphi[20];   //[ngen]
   Float_t         gendphijt[20];   //[ngen]
   Float_t         gendrjt[20];   //[ngen]
   Int_t           gensubid[20];   //[ngen]
   Float_t         smpt[400];   //[nref]
...
void setupJetTree(TTree *t,Jets &tJets,bool doCheck = 0)
{
   ...
   t->SetBranchAddress("hcalSum", tJets.hcalSum, &tJets.b_hcalSum);
   t->SetBranchAddress("ecalSum", tJets.ecalSum, &tJets.b_ecalSum);
   ...
   t->SetBranchAddress("matchedRawPt", tJets.matchedRawPt, &tJets.b_matchedRawPt);
   t->SetBranchAddress("matchedPu", tJets.matchedPu, &tJets.b_matchedPu);
   ...
   t->SetBranchAddress("subid", tJets.subid, &tJets.b_subid);
   ...
   if (doCheck) {
      if (t->GetMaximum("nref")>400) cout <<"FATAL ERROR: Arrary size of nref too small!!!  "<<t->GetMaximum("nref")<<endl;
      if (t->GetMaximum("ngen")>20) cout <<"FATAL ERROR: Arrary size of ngen too small!!!  "<<t->GetMaximum("ngen")<<endl;
   }
}
